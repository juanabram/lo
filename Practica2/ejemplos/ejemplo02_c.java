...
public class ejemplo02_c {
    ...
    {
        arreglo.forEach((info)->System.out.println(info.getClass()+" "+info.toString()));

        System.out.println("\n se va a eliminar el ultimo elemento");
        arreglo.remove(arreglo.size()-1); // elimina el ultimo elemento del arraylist

        arreglo.forEach((info)->System.out.println(info.getClass()+" "+info.toString()));

        System.out.println("\n se va Todos los elementos");
