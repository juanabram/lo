...
public class ejercicio02 {
    ...
    public static void AltaCosto() throws IOException
    {
        Concepto nodo;
        String codigo, costo;
        codigo = dialogo("Introduce el codigo del Concepto a Asignar Precio ");
        if (existe(codigo))
        {
            nodo = BuscarConcepto(codigo);
            costo = dialogo("Introduce el costo del Insumo " + nodo.insumo);
            Insumo auxnodo = new Insumo();
            auxnodo.codigo = nodo.codigo ;
            auxnodo.costo = costo ;
